...
//                       <button onClick={async()=>{ if(confirm('Delete?')){ await deleteBook(b._id); load(); } }} style={btnDanger}>Delete</button>
//                     </div>
//                   </td>
//                 </tr>
//               ))}
...
//         <button disabled={page<=1} onClick={()=> setParams(p=>{ p.set('page', String(page-1)); return p; })} style={btn}>&lt; Prev</button>
//         <span style={{padding:'8px 12px'}}>Page {page} of {totalPages}</span>
//         <button disabled={page>=totalPages} onClick={()=> setParams(p=>{ p.set('page', String(page+1)); return p; })} style={btn}>Next &gt;</button>
//       </div>
//     </div>
//   );
// }
